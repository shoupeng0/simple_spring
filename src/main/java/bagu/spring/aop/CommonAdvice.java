...
public abstract class CommonAdvice implements Advice {
    ...
    public CommonAdvice(Method aspectJAdviceMethod, Object aspectInstance) {
    ...
    protected void setThrowingName(String name) {
        if (name.equals("ex")) {
            ...
            //@AfterThrowing 的 参数列表第 0 个必须是异常类
            Class<?> exClass = null;
            try {
